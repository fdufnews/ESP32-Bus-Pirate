...
inline constexpr InfraredCommandStruct universalOnOff[]  = {
    ...
    { _SAMSUNG36,   0,  -1, 44 },   // Samsung 36bit variant
    ...
    // Bose
    { _BOSE,        1,  -1, 10 },   // Bose power

    // Pioneer
    { _PIONEER,     0,  -1, 1260 }, // Pioneer power
    ...
    { _PIONEER,     1,   0, 64 },   // Pioneer alt
    { _BOSE,        0,  -1, 71 }   // Bose alt
};
